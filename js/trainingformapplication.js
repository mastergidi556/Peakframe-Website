   ...
   $(function(){
        $("#submit").click(function(){
         ...
         if($("#firstname").val() == "")
         {
             ...
             topFunction();
             $("span#firstnamehelp").html("Required");
             return false;
         }
         ...
         {
          alert ("You must select at least a course !");
          return false;
         }
         else
         {
    ...
    function submitForm()
    {
       ...
       document.getElementById("trainingform").action = "training_server_validate.php";
       document.getElementById("trainingform").submit();
       
    }
     function checkTheBox() {
        for (var i = 0; i< 2 ; i++) {
          if(document.myform["courses[]"][i].checked){
            flag ++;
          }
        }
    }
